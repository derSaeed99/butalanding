...
export const Ratings = () => {
    ...
    useEffect(() => {
        const getRatings = async () => {
            ...
            const ratings = ratingsDocs.map((item) => item)
            setValuations(ratings)
        }
        getRatings();
    }, [])
    return (
        <Grid container display="flex" alignItems="center" justifyContent="center" sx={{
            height: "auto",
            maxWidth: "100%"
        }}>
            <Grid item>
                <Typography variant="h4" gutterBottom sx={{ color: theme.palette.primary.dark, mb: 2 }}>Bewertungen</Typography>
            </Grid>
